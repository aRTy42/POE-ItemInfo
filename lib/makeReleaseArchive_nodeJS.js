...
var repoOwner 	= repositoryURLParts[repositoryURLParts.length-1]
var repoProject = repositoryURLParts[repositoryURLParts.length-2]
...
function continueAfterWaiting() {	
	...
	request(options, function (error, response, body) {
		...
		if (!release.tag_name) {
			console.log(" \x1b[31mError:\x1b[0m couldn't find a release.");
		}
		else {
